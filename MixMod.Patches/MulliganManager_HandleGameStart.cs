	...
	public static class MulliganManager_HandleGameStart
	{
		public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
		{
			...
			if (num > 0)
			{
				...
				list.Insert(num++, new CodeInstruction(OpCodes.Callvirt, typeof(MixModConfig).GetProperty("SkipHeroIntro", BindingFlags.Instance | BindingFlags.Public).GetGetMethod()));
			}
			return list;
		}
	}
